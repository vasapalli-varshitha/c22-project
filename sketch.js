...
function keyPressed()
{
  if(keyCode===RIGHT_ARROW)
    {
      Matter.Body.applyForce(ball_1,{x:0,y:0},{x:0.20,y:0});
    }

    if(keyCode===DOWN_ARROW)
    {
      Matter.Body.applyForce(ball_2,{x:0,y:0},{x:0.20,y:0});
    }
	

  if(keyCode===LEFT_ARROW)
    {
      Matter.Body.applyForce(ball_3,{x:0,y:0},{x:0.20,y:0});
    }

    if(keyCode===UP_ARROW)
    {
      Matter.Body.applyForce(ball_4,{x:0,y:0},{x:0.20,y:0});
    }

	if(keyCode===SPACE)
    {
      Matter.Body.applyForce(ball_5,{x:0,y:0},{x:0.20,y:0});
    }
